...
- Fixed a bug where `is_dijoint` calls `sort` incorrectly causing an error when evaluating unsorted intervals. ([#](https://github.com/neuro-galaxy/temporaldata/pull/))
