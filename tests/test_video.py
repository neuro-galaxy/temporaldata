...
class TestLazyVideoLoader:
    ...
    @pytest.fixture
    def timestamps(self):
        return np.arange(self.num_frames) / 1.  # cast to float
    ...
    def test_timestamp_check(self, video_file, timestamps):
        ...
        timestamps_bad = np.arange(timestamps.shape[0] + 10) / 1.
    ...
    def test_option_validation(self, video_file, timestamps):
        ...
        with pytest.raises(ValueError):
            LazyVideo(timestamps=timestamps, video_file=video_file, channel_format='NHCW')
